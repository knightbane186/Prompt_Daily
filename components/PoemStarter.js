...
const PoemStarter = () => {
  return (
    ...
    <View className="flex-row justify-between bg-[#2c2c2d] p-6 mb-[-11] pt-3 rounded-t-lg  ">
      <Text className=" pt-2 text-xs text-white">PROMPT OF THE DAY</Text>
    </View>
    <View className="flex flex-col box bg-[#1c1c1e] rounded-lg w-[387]

    items-left  p-2 justify-center space-x-8 relative">
    
    <View className="absolute top-0  space-y-3 text-left mt-2">
      <Text className=" ml-3 px-3 py-1 text-sm text-white bg-[#1581ff] rounded-lg">STORY STARTER</Text>
    </View>
